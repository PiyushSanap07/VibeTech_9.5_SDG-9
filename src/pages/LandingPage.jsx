        ...
        <div className="min-h-screen bg-white text-[#000000] relative overflow-hidden font-sans">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 opacity-10">
                    <div className="absolute transform rotate-45 -left-1/4 -top-1/4 w-1/2 h-1/2 bg-[#4EA685] blur-3xl"></div>
                    <div className="absolute transform rotate-45 -right-1/4 -bottom-1/4 w-1/2 h-1/2 bg-[#57B894] blur-3xl"></div>
                </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <div className="flex flex-col items-center space-y-4">
                                <Link
                                    ...
                                    className="group w-full sm:w-80 px-8 py-4 bg-[#4EA685] hover:bg-[#57B894] rounded-2xl transition-all duration-300 shadow-xl shadow-[#4EA685]/30 flex items-center justify-center space-x-3 text-white"
                                >
                                ...
                                <Link to="/innovator/login" className="text-[#757575] hover:text-[#4EA685] text-sm transition-colors">
                            ...
                            <div className="flex flex-col items-center space-y-4">
                                <Link
                                    to="/funder/register"
                                    className="group w-full sm:w-80 px-8 py-4 bg-[#57B894] hover:bg-[#4EA685] rounded-2xl transition-all duration-300 shadow-xl shadow-[#57B894]/30 flex items-center justify-center space-x-3 text-white"
                                >
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <Link to="/funder/login" className="text-[#757575] hover:text-[#4EA685] text-sm transition-colors">
                                    Already have an account? <span className="font-semibold underline">Log in</span>
                                </Link>
                            </div>
                        </div>
            ...
            <div id="features" className="container mx-auto px-6 py-24">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-[#000000]">
                    How It <span className="text-[#4EA685]">Works</span>
                </h2>
                <div className="grid md:grid-cols-3 gap-8">
                    {/* Feature 1 */}
                    <div className="group p-8 bg-white rounded-3xl border border-[#efefef] hover:border-[#4EA685]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#4EA685]/10">
                        <div className="w-14 h-14 bg-[#4EA685] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#4EA685]/20">
                    ...
                    {/* Feature 2 */}
                    <div className="group p-8 bg-white rounded-3xl border border-[#efefef] hover:border-[#4EA685]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#4EA685]/10">
                        <div className="w-14 h-14 bg-[#57B894] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#57B894]/20">
                            <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Feature 3 */}
                    <div className="group p-8 bg-white rounded-3xl border border-[#efefef] hover:border-[#57B894]/50 transition-all duration-300 hover:shadow-xl hover:shadow-[#57B894]/10">
                        <div className="w-14 h-14 bg-[#4EA685] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#4EA685]/20">
                            <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
