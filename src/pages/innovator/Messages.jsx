          ...
          {loading ? (
            ...
            conversations.map(conv => (
              <button
                ...
                className={`w-full p-4 rounded-2xl flex items-center space-x-4 transition-all group ${selectedChat?.id === conv.id
                ...
                return (
                  ...
                  >
                    <div className={`max-w-[70%] space-y-1 ${isMe ? 'items-end' : 'items-start'}`}>
                      <div className={`px-5 py-3.5 rounded-3xl text-sm font-medium shadow-sm border ${isMe
